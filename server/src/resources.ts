...
export const possibleOptions: string[] = [
    ...
    "periods", "pinradius", "pointerposition", "portal", "position", "primarykey", "properties", "range", "rangemerge",
    "rangeoffset", "rangeselectend", "rangeselectstart", "rate", "ratecounter", "ratio", "refresh", "refreshinterval",
    "reload", "render", "replace", "replaceunderscore", "replacevalue", "responsive", "retaintimespan",
    "retryrefreshinterval", "rightaxis", "ringwidth", "rotatelegendticks", "rotatepaletteticks", "rotateticks",
    "rowalertstyle", "rowstyle", "rule", "scale", "scalex", "scaley", "script", "selectormode", "serieslabels",
    "serieslimit", "seriestype", "seriesvalue", "server", "serveraggregate", "severity", "severitystyle",
    "showtagnames", "size", "sizename", "sort", "source", "stack", "start", "starttime", "startworkingminutes",
    "statistic", "statistics", "stepline", "style", "summarize", "summarizeperiod", "summarizestatistic", "svg",
